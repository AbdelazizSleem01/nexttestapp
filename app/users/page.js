...
export default function Users() {
    return (
        <>
            <Hero title={"Users"} />
            <div className="bg-white shadow-md rounded-md overflow-hidden max-w-lg mx-auto mt-16 mb-16">
                ...
                <ul className="divide-y divide-gray-200">
                    ...
                    <li className="flex items-center py-4 px-6">
                        ...
                        <img className="w-12 h-12 rounded-full object-cover mr-4" src="https://randomuser.me/api/portraits/men/40.jpg" alt="User avatar" />
                        <div className="flex-1">
                    ...
                    <li className="flex items-center py-4 px-6">
                        ...
                        <img className="w-12 h-12 rounded-full object-cover mr-4" src="https://randomuser.me/api/portraits/women/54.jpg" alt="User avatar" />
                        <div className="flex-1">
                    ...
                    <li className="flex items-center py-4 px-6">
                        ...
                        <img className="w-12 h-12 rounded-full object-cover mr-4" src="https://randomuser.me/api/portraits/men/83.jpg" alt="User avatar" />
                        <div className="flex-1">
                    ...
                    <li className="flex items-center py-4 px-6">
                        ...
                        <img className="w-12 h-12 rounded-full object-cover mr-4" src="https://randomuser.me/api/portraits/women/17.jpg" alt="User avatar" />
                        <div className="flex-1">
