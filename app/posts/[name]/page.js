                ...
                <div class="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
                    <div class="border-b px-4 pb-6">
                        <div class="text-center my-4">
                            <iframe class="mt-6 w-80 mx-auto my-4 h-52 rounded-lg" src={`https://maps.google.com/maps?q=${post.address.geo.lat},${post.address.geo.lng}&t=&z=6&ie=UTF8&iwloc=&output=embed`}  frameborder="0"></iframe>

                            <div class="py-2">
                                <h3 class="py-2 font-bold text-2xl text-gray-800 dark:text-white mb-1">{post.name}</h3>
